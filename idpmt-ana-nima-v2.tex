...
\hline 
$\mu$  &  $w$ &  $\alpha$ (nVs$^{-1}$) &  $Q$ (nVs) &  $\sigma$ (nVs) \\[0.6ex] \hline\hline % & $\chi^2$/NDOF\\[0.6ex] \hline\hline
...
\bibitem{dark} T. Alexander {et al.} (DarkSide collaboration), \emph{Light Yield in DarkSide-10: A Prototype Two-Phase Argon TPC for Dark Matter Searches}, 
